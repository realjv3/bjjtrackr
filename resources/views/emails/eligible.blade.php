...
<head>
    ...
    <title>{{$name}} is eligible for a promotion!</title>
    <style type="text/css">
        /* -------------------------------------
            GLOBAL
        ------------------------------------- */
...
<table class="body-wrap">
    <tr>
        ...
        <td class="container" width="600">
            <div class="content"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="em_full_wrap" align="center"  bgcolor="#efefef">
                    <tr>
                    ...
                    <tr>
                        <td class="content-wrap">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        Upon their next checkin, {{$name}} will be eligible for their {{$rank}},
