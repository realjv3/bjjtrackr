                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-button es-p10t es-p20b" align="center">
                                                                <span class="es-button-border" style="border-width: 0px; border-style: solid; background: none 0% 0% repeat scroll #26a4d3; border-color: #26a4d3;">
                                                                    <a href="https://flowrolled.com/" class="es-button" target="_blank" style="background: #26a4d3 none repeat scroll 0% 0%; border-color: #26a4d3;">ACCESS ACCOUNT</a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t" align="left">
                                                                <p style="color: #222222; font-size: 14px;"><strong>John Verity</strong><br></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p style="color: #666666; font-size: 14px;">Founder | FlowRolled</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-p10b" align="center">
                                                                <p style="color: #aad4ea; font-size: 17px;">Please contact us using the in-app feedback form<br></p>
                                                            </td>
                                                        </tr>
{{--                                                        <tr>--}}
{{--                                                            <td class="esd-block-button es-p10" align="center">--}}
{{--                                                                <span class="es-button-border" style="background: #ffffff none repeat scroll 0% 0%;">--}}
{{--                                                                    <a href="https://viewstripo.email/" class="es-button es-button-1626285256205" target="_blank" style="background: #ffffff none repeat scroll 0% 0%; border-color: #ffffff; color: #26a4d3; border-width: 15px 25px;">GIVE FEEDBACK</a>--}}
{{--                                                                </span>--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
                                                        </tbody>
...
{{--                                                        </tr>--}}
                                                        <tr>
                                                            <td class="esd-block-text es-p10b" align="center">
                                                                <p>This email was sent to you from flowrolled.com</p>
                                                            </td>
                                                        </tr>
{{--                                                        <tr>--}}
...
{{--                                                        </tr>--}}
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <p>Copyright © {{date('Y')}} <strong>FlowRolled</strong>, All Rights Reserved.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
...
{{--                                                                <a target="_blank" href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=information&utm_content=trigger_newsletter4">--}}
{{--                                                                    <img src="https://tlr.stripocdn.email/content/guids/CABINET_9df86e5b6c53dd0319931e2447ed854b/images/64951510234941531.png" alt width="125">--}}
{{--                                                                </a>--}}
                                                            </td>
                                                        </tr>
                                                        </tbody>
